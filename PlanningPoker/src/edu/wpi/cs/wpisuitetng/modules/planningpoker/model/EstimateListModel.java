...
public class EstimateListModel {
	...
	/**
	 * Add a SimpleListObserver that is notified when the list of estimates is changed
	...
	/**
	 * Update a user's estimate. Doesn't do anything if the user is not in the list.
