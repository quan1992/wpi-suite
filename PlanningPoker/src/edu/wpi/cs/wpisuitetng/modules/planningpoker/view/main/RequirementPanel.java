...
public class RequirementPanel extends JPanel {
     ...
     * 
     */
    private static final long serialVersionUID = 8287394208101155893L;
    ...
    public RequirementPanel() {
        ...
        groupLayout.setVerticalGroup(groupLayout.createParallelGroup(
                ...
                groupLayout
                        .createSequentialGroup()
                        .addGap(6)
                        .addComponent(panel, GroupLayout.PREFERRED_SIZE, 58,
                                GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(panel_1, GroupLayout.PREFERRED_SIZE, 168,
                                GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addGroup(
                                groupLayout
        ...
        gl_panel_3.setHorizontalGroup(gl_panel_3.createParallelGroup(
                ...
                gl_panel_3.createSequentialGroup().addGap(5)
                        .addComponent(lblNewLabel_2).addGap(5)
        ...
        gl_panel_2.setHorizontalGroup(gl_panel_2.createParallelGroup(
                ...
                gl_panel_2.createSequentialGroup().addGap(5)
                        .addComponent(lblNewLabel_1).addGap(5)
        ...
        gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(
                ...
                gl_panel_1
                        ...
                        .addComponent(lblNewLabel)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(textPane, GroupLayout.DEFAULT_SIZE, 132,
