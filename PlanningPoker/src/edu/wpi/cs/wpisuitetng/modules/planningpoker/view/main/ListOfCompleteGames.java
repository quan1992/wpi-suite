...
public class ListOfCompleteGames extends JPanel {
     ...
     * 
     */
    private static final long serialVersionUID = -7591095132453615934L;
    ...
    public ListOfCompleteGames() {
        ...
        SummaryPanel.setLayout(new MigLayout("", "[grow][]",
                "[][grow][grow][grow]"));
        ...
        table_1.setModel(new DefaultTableModel(new Object[][] {}, new String[] {
            ...
            /**
                     * 
                     */
            private static final long serialVersionUID = -5981821507668731773L;
        ...
        StatsPanel.setBorder(new TitledBorder(null, "Stats",
        ...
        Admin.setBorder(new TitledBorder(null, "Admin", TitledBorder.LEADING,
    ...
    /**
     * Switches the right summary panel between a blank panel for when no game
     * is selected to a summary panel showing stats about the selected game
     * 
     * @author tcarmstrong
     */
    ...
    /**
     * Calculates the average value of the submitted estimates in the summary
     * table. This method automatically sets the value of the mean label in the
     * panel.
     * 
    ...
    /**
     * Calculates the median value of the submitted estimates in the summary
     * table. This method automatically sets the value of the median label in
     * the panel.
     * 
    ...
    public float calcMedian() {
        ...
        if (nums.size() % 2 == 1) { // if size is odd
            ...
            median = (nums.get(nums.size() / 2) + nums.get(nums.size() / 2 - 1)) / 2; // median
                                                                                      // is
                                                                                      // average
                                                                                      // of
                                                                                      // two
    ...
    public void addUserAndEstimate(String username, float estimate) {
        ((DefaultTableModel) (getSummaryTableModel())).addRow(new Object[] {
                username, estimate });
    }
